...
if (isset($_POST["ids"])) {
    try {
        ...
        $status = (isset($_POST["status"]) ? $_POST["status"] : $status = "belum lunas");

        $order = array(
            'user_id' => $_SESSION["account"],
            'nama_user' => $_SESSION["usernameLogin"],
            'ids' => $ids,
            'status' => $status
...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php">Sinar Jaya</a>
        </div>
